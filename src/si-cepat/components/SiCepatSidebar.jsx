...
export default function SiCepatSidebar({ active, onSelect, onLogout, user }) {
  ...
  return <div className="system-sidebar-wrap"><aside className="system-sidebar">
    <div className="system-brand"><div className="system-brand-logo"><img src="/logo-gandeng.png" alt="Si Cepat" /></div><div className="system-brand-copy"><div className="system-brand-title">SI CEPAT</div><div className="system-brand-subtitle">Pengajuan & Kerja Sama</div></div></div>
