...
const PANDUAN_STEPS = [
  [1, "Akses via SAKTI", "Masuk menggunakan akun SAKTI (Humas / ASMAN / MADM) untuk mengelola modul Si Cepat."],
  [2, "Lihat & Kelola Proposal", "Buka menu Proposal & Evaluasi Mitra untuk melihat pengajuan yang masuk."],
  [3, "Pantau Status & Timeline", "Gunakan Tracking Status untuk memantau perkembangan tahapan evaluasi Humas → ASMAN → MADM."],
  [4, "Persetujuan & Rekapitulasi", "Proses evaluasi dan berikan persetujuan atau catatan perbaikan pada proposal mitra."],
];
const FAQS = [
  ["Bagaimana cara mengakses modul Si Cepat?", "Akses Si Cepat sudah terintegrasi penuh dalam akun SAKTI pengguna."],
  ["Bagaimana alur review pengajuan proposal Si Cepat?", "Pengajuan diperiksa oleh Humas, kemudian diteruskan ke ASMAN dan MADM sesuai hasil verifikasi."],
  ["Apa yang harus dilakukan jika ada proposal dikembalikan?", "Buka detail pengajuan untuk melihat catatan evaluator sebagai acuan tindak lanjut."],
];
...
export default function SiCepatBantuan() {
  ...
  return (
    <div style={{fontFamily:font.body,padding:"clamp(18px,3vw,28px) clamp(16px,4vw,32px)",maxWidth:820,width:"100%",boxSizing:"border-box"}}>
      <PageHeader title="Pusat Bantuan" description="Panduan penggunaan, pertanyaan umum, dan akses langsung ke admin Si Cepat." />
