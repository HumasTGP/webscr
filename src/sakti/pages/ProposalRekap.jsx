      ...
      <div>
        ...
        >
          ...
          <p style={{ color: T.muted, fontSize: 12, marginTop: 14, lineHeight: 1.5 }}>
            Data proposal itu sendiri tidak bisa diunduh sebagai dokumen terpisah - yang bisa
            diunduh hanya dokumen turunannya (BAST dan PI), sesuai template resmi. Preview datanya
            akan ditampilkan dulu, file .docx baru dibuat & diunduh setelah kamu konfirmasi.
          </p>
        </Modal>
