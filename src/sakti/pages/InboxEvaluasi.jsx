...
export default function InboxEvaluasiPage({ user, evaluasiList, onUpdateEvaluasi, notify }) {
  ...
  const doApprove = () => {
    ...
    notify(`Evaluasi ${detail.proposalId} disetujui - dikirim ke MADM.`, "success");
    setDetail(null);
  };
  ...
  const doReject = () => {
    ...
    notify(`Evaluasi ${detail.proposalId} ditolak - catatan dikirim ke Humas.`, "error");
  ...
  const doProcess = () => {
    ...
    notify(`Evaluasi ${detail.proposalId} selesai diproses - notifikasi dikirim ke Humas.`, "success");
    setDetail(null);
  };
  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          user.role === "asman"
            ? "Form Evaluasi proposal yang dikirim Humas. Klik untuk buka, beri catatan, lalu setujui / tolak."
            : "Form Evaluasi yang sudah disetujui Asman. Tandai selesai diproses atau tolak dengan catatan."
        }
      />
      ...
      <Modal
        ...
        title={detail ? `Evaluasi ${detail.proposalId}` : ""}
        icon={ClipboardList}
        width={560}
      >
        {detail && liveDetail && (
          <>
            ...
            <div style={{
              ...
              <div style={{ color: T.muted }}>Keputusan Otomatis</div>
              <div>{liveDetail.keputusan}</div>
              {liveDetail.catatan && (
                <>
                  <div style={{ color: T.muted }}>Catatan Humas</div>
      ...
      >
        ...
        <textarea
          ...
          placeholder="Contoh: skor kategori Publikasi kurang sesuai, mohon ditinjau ulang."
          rows={4}
          style={{
