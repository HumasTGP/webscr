...
export const torFields = (rabIdOptions) => (_opsi, _values, _autoFrom) => [
  ...
  { key: "judulProgramRKA", label: "Judul Program RKA", type: "select", options: OPT.judulProgramRKA },
  {
    key: "judulKegiatan",
  ...
  { key: "hariTanggal", label: "Hari/Tanggal", type: "date", section: "Rencana Kegiatan" },
  { key: "tempat", label: "Tempat" },
  { key: "narasumber", label: "Narasumber", full: true },
];
